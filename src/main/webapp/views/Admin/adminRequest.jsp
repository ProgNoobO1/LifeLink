                        ...
                        <div class="actions">
                            <c:choose>
                                <c:when test="${!u.approved}">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/admin/users/delete" style="display:inline;" onsubmit="return confirm('Reject and delete this registration?');">
                                        <input type="hidden" name="id" value="${u.id}"/>
                            ...
                            <a href="${pageContext.request.contextPath}/admin/users/edit?id=${u.id}" class="action-btn view-btn">
