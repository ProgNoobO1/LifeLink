...
<aside class="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <a href="#" class="nav-item active">
            ...
            Dashboard
            <span style="margin-left:auto; width:4px; height:26px; background:rgba(255,255,255,.5); border-radius:999px;"></span>
        </a>

        <a href="../views/Admin/adminManageUsers.jsp" class="nav-item">
