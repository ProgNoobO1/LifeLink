...
<aside class="sidebar" id="mainSidebar">
    ...
    <div class="sidebar-section">
        ...
        <a href="${pageContext.request.contextPath}/recipient/requests"
           class="nav-item <%= (_uri.contains("/recipient/requests") || _uri.contains("/views/recipient/my_requests.jsp")) ? "active" : "" %>">
