...
INSERT INTO districts (name, province) VALUES
    ...
    ('Bara', 'Madhesh'), ('Dhanusha', 'Madhesh'), ('Mahottari', 'Madhesh'), ('Parsa', 'Madhesh'), ('Rautahat', 'Madhesh'),
    ('Saptari', 'Madhesh'), ('Sarlahi', 'Madhesh'), ('Siraha', 'Madhesh'),
    ...
    ('Mustang', 'Gandaki'), ('Myagdi', 'Gandaki'), ('Nawalpur', 'Gandaki'), ('Parbat', 'Gandaki'), ('Syangja', 'Gandaki'), ('Tanahun', 'Gandaki'),
    ('Arghakhanchi', 'Lumbini'), ('Banke', 'Lumbini'), ('Bardiya', 'Lumbini'), ('Dang', 'Lumbini'), ('Gulmi', 'Lumbini'),
    ('Kapilvastu', 'Lumbini'), ('Parasi', 'Lumbini'), ('Palpa', 'Lumbini'), ('Pyuthan', 'Lumbini'), ('Rolpa', 'Lumbini'),
    ('Rukum East', 'Lumbini'), ('Rupandehi', 'Lumbini'),
    ('Dailekh', 'Karnali'), ('Dolpa', 'Karnali'), ('Humla', 'Karnali'), ('Jajarkot', 'Karnali'), ('Jumla', 'Karnali'),
    ('Kalikot', 'Karnali'), ('Mugu', 'Karnali'), ('Rukum West', 'Karnali'), ('Salyan', 'Karnali'), ('Surkhet', 'Karnali'),
    ('Achham', 'Sudurpashchim'), ('Baitadi', 'Sudurpashchim'), ('Bajhang', 'Sudurpashchim'), ('Bajura', 'Sudurpashchim'),
    ('Dadeldhura', 'Sudurpashchim'), ('Darchula', 'Sudurpashchim'), ('Doti', 'Sudurpashchim'), ('Kailali', 'Sudurpashchim'), ('Kanchanpur', 'Sudurpashchim');
...
CREATE TABLE blood_requests (
    ...
    donor_id        INT UNSIGNED,            -- target donor user (optional for direct request)
    blood_group_id  TINYINT UNSIGNED NOT NULL,
...
-- Seed Donor: user_id = 2, email = donor@lifelink.com, name = Alex Morgan, blood_group = O+ (id = 7)
INSERT INTO users (id, full_name, email, password_hash, confirm_password_hash, role, is_active, is_approved)
VALUES (2, 'Alex Morgan', 'donor@lifelink.com', 'password', 'password', 'donor', 1, 1);

INSERT INTO donors (user_id, blood_group_id, district_id, address, gender, weight_kg, is_available)
VALUES (2, 7, 27, 'Kathmandu', 'male', 75.0, 1);

-- Seed Recipient: user_id = 3, email = recipient@lifelink.com, name = Jane Recipient, blood_group = A+ (id = 1)
INSERT INTO users (id, full_name, email, password_hash, confirm_password_hash, role, is_active, is_approved)
VALUES (3, 'Jane Recipient', 'recipient@lifelink.com', 'password', 'password', 'recipient', 1, 1);

INSERT INTO recipients (user_id, blood_group_id, district_id, address, gender)
VALUES (3, 1, 27, 'Kathmandu', 'female');
